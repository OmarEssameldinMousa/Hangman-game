...
async function DrawHangMan() {
    ...
    let components = [basef, standingbarf, hangbarf, ropf, manheadf, manbodyf, manleftarmf, manrightarmf, manleftlegf, manrightlegf]
    let error_counter = 0;
    document.addEventListener("click", function () {
        components[error_counter]();
        mainDrawingDiv.appendChild()
        error_counter++;
    })
}
